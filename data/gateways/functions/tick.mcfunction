...
execute as @e[type=item,limit=1,nbt={OnGround: 1b},nbt={Item: {id: "minecraft:dragon_breath", Count: 1b}}] at @s if data entity @s Item.tag.Placement if block ~ ~-1 ~ minecraft:lodestone run function gateways:place_gateway
